...
function renderAuto(result) {
  ...
  <p class="section__lead">
    ...
    и объяснение, почему выбран именно такой вариант. Если решение не годится — поправьте его
    в окне «Разобрать спорные места»: там же лежит и кнопка возврата к варианту программы.
  </p>
